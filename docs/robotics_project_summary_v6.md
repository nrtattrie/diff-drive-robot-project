...
- [ ] Begin ROS 2 Jazzy tutorials: https://docs.ros.org/en/jazzy/Tutorials.html
- [ ] Read ROS 2 Jazzy documentation overview (concepts, architecture)

### When SSD Arrives:
- [ ] Flash Ubuntu 24.04 LTS (Noble) Desktop (64-bit) onto NVMe SSD
- [ ] Install ROS 2 Jazzy (LTS version, officially supported on Ubuntu 24.04)
...
**Primary Setup:**
- Raspberry Pi 5 (8GB) running Ubuntu 24.04 LTS Desktop (Noble) + ROS 2 Jazzy
